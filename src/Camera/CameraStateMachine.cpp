	...
	m_eCurrentState(E_CAMERA_MODE_STATE_FLYCAMERA)
{
	...
	m_cameraStatesArray[E_CAMERA_MODE_STATE_STATIC] = std::make_shared<StaticCamera>(a_v4Perspective);
	...
	m_cameraStatesArray[E_CAMERA_MODE_STATE_LOCATION] = std::make_shared<LocationCamera>(a_v4Perspective);
